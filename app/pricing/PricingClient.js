    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-[#007A5E] py-12">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl text-[#FCD116] font-bold mb-3">No Hidden Fees. No Credit Card Required. Forever Free.</p>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-[#007A5E] to-[#004A38] border-4 border-green-400 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition">
              ...
              <div className="text-center">
                <Link href="/add-listing" className="block bg-[#FCD116] hover:bg-[#e0bc10] text-[#1a1a1a] font-black text-lg px-8 py-4 rounded-xl transition shadow-lg">Add Your Business Now →</Link>
                <p className="text-white/70 mt-3 text-xs">No credit card required • Takes less than 5 minutes</p>
              </div>
            </div>

            <div className="bg-gradient-to-br from-[#007A5E] to-[#004A38] border-4 border-[#FCD116] rounded-2xl p-8 shadow-lg">
              <div className="text-center mb-6">
                <div className="inline-block bg-[#FCD116] text-[#1a1a1a] px-6 py-2 rounded-full font-bold text-sm mb-4">COMING SOON</div>
              ...
              <div className="space-y-3 mb-8">
                ...
                {[
                  ['Gold border & star badge', 'Stand out with premium styling'],
                  ['Top of category results', 'Appear first in search results'],
                  ['Homepage featured section', 'Maximum visibility on homepage'],
                  ['Priority placement', 'Always listed first in your category']
                ].map(([title, desc]) => (
                  <div key={title} className="flex items-start gap-3">
              ...
              <div className="text-center">
                <Link href="/contact?subject=Featured Listing Inquiry" className="block bg-white hover:bg-gray-100 text-[#007A5E] font-black text-lg px-8 py-4 rounded-xl transition shadow-lg">Get Early Access →</Link>
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              ['Do I need a credit card?', "No credit card required. Simply fill out the form and you're done!"],
              ['How long to get listed?', 'Most listings are reviewed and published within 24-48 hours.'],
              ['Can I update my listing?', 'Absolutely! Claim your listing and update anytime.'],
              ['What are Featured Listings?', 'Premium placement with gold borders, star badges, and top visibility. Coming Q2 2026!'],
              ['Will my listing stay free?', 'Yes! Your basic listing will always remain free. Featured is optional.']
            ].map(([q, a]) => (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <div><div className="font-bold">Grenada Search</div><div className="text-sm text-gray-400">Directory</div></div>
              </div>
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm">contact@grenadasearch.com</p>
