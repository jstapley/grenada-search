      ...
      <div className="bg-gray-50 border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <div className="flex items-center gap-2 text-xs md:text-sm overflow-x-auto">
            ...
            <Link href="/categories" className="text-[#007A5E] hover:text-[#005F48] whitespace-nowrap">Categories</Link>
            <span className="text-gray-400">/</span>
            <span className="text-gray-700 font-semibold truncate">{category.name}</span>
          </div>
        </div>
      </div>
      ...
      <section className="bg-[#007A5E] py-8 md:py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-4 md:gap-6 flex-wrap">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl px-4 md:px-6 py-2 md:py-3 border border-white/20">
              <span className="text-2xl md:text-3xl font-bold text-[#FCD116]">{parishes.length}</span>
              <span className="text-white ml-2 text-sm md:text-base">Parishes</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <section className="bg-white border-b border-gray-200 py-4">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-start md:items-center gap-3 flex-wrap">
              <span className="text-gray-700 font-semibold text-sm md:text-base whitespace-nowrap">Filter by location:</span>
              {parishes.map((parish) => (
                <Link
                  key={parish.id}
              ...
              {listings.map((listing) => (
                ...
                >
                  ...
                  <div className="p-4 md:p-6">
                    <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-2 group-hover:text-[#007A5E] transition">
                    ...
                    <div className="flex items-center justify-between gap-2">
                      {listing.address && (
                        <div className="text-gray-500 text-xs md:text-sm flex items-center gap-1 truncate flex-1">
      ...
      <section className="bg-gray-50 py-8 md:py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-600 mb-6 text-base md:text-lg px-4">
            Join our directory and connect with thousands of visitors exploring Grenada
          </p>
